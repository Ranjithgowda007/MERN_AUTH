...
import instructorImage from "../assets/profile_img.png";
    ...
    <div className="instructor-page">
      <div className="instructor-card">
        ...
        <div className="instructor-info">
          <h1>Ranjiith Gowda</h1>
          <h4>Your Instructor</h4>
          <p>
            Hello! I'm Ranjiith Gowda, a passionate MERN stack developer
          ...
          <div className="social-links">
            <a
              href="https://github.com/Ranjithgowda007"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/ranjitgowda/"
              target="_blank"
              rel="noopener noreferrer"
            >
              LinkedIn
